...
class ThreeHundredOneBoard : public DartBoard
{
	public:
		...
		virtual int placeDart(std::string& playerName, int successRate, int ptsWanted, Zone zone = Zone::Single, Zone* hitZone = nullptr, ThrowError* erorr = nullptr,std::vector<int>* throws = nullptr) override;
};
