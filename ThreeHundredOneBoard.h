...
class ThreeHundredOneBoard : public DartBoard
{
	public:
		...
		virtual int placeDart(std::string& playerName, int successRate, int ptsWanted, Zone zone = Zone::Single, ThrowError* erorr = nullptr,std::vector<int>* throws = nullptr) override;
};
