...
class ThreeHundredOneBoard : public DartBoard
{
	public:
		...
		virtual int placeDart(std::string& playerName, int successRate, int ptsWanted, Zone zone = Zone::Single, Zone* hitZone = nullptr, ThrowError* erorr = nullptr,std::vector<std::pair<int,int>>* throws = nullptr) override;
};
