...
public:
		...
		virtual int placeDart(std::string& playerName, int successRate, int ptsWanted, Zone zone = Zone::Single, ThrowError* error = nullptr, std::vector<int>* throws = nullptr) override;
};
