...
int ThreeHundredOneBoard::placeDart(const std::string& playerName, int accuracy, int wantedNumber, Zone zone, Zone* hitZone, ThrowError* error,std::vector<std::pair<int,Zone>>* throws)
{
